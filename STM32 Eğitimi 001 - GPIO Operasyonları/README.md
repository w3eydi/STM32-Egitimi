...
Artık <kbd>Ctrl</kbd> + <kbd>S</kbd> veya üstteki Generate Code seçeneğiyle kodlarımızı derleyebiliriz. Şimdi **main.c** dosyasını açalım ve Led Yakma projemize geçelim.
